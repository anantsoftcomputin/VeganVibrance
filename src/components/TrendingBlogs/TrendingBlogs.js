        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8">
            {[...Array(3)].map((_, index) => (
              ...
              >
                <div className="relative h-48 bg-green-100 animate-pulse"></div>
                <div className="p-6">
                  <div className="h-6 bg-green-100 rounded animate-pulse mb-4"></div>
                  <div className="h-4 bg-green-100 rounded animate-pulse mb-2"></div>
                  <div className="h-4 bg-green-100 rounded animate-pulse mb-2"></div>
                  <div className="h-4 bg-green-100 rounded animate-pulse mb-4 w-2/3"></div>

                  <div className="flex flex-wrap gap-2 mb-4">
                    {[...Array(3)].map((_, tagIndex) => (
                      <div
                        key={tagIndex}
                        className="h-6 w-16 bg-green-100 rounded-md animate-pulse"
                      ></div>
                    ))}
                  </div>
                  ...
                  <div className="mt-auto">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-full bg-green-100 animate-pulse"></div>
                      <div className="flex-1">
                        <div className="h-4 bg-green-100 rounded animate-pulse mb-2"></div>
                        <div className="h-3 bg-green-100 rounded animate-pulse w-1/2"></div>
                      </div>
                    </div>
                    <div className="flex justify-between">
                      <div className="h-4 w-28 bg-green-100 rounded animate-pulse"></div>
              ...
              <Link key={index} href={`/${blog.slug}`}>
                <article className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col">
                  ...
                  <div className="p-4 sm:p-6 flex flex-col flex-grow">
                    <p className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-green-600 transition-colors">
                      {blog.title}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-3 items-center justify-between text-xs sm:text-sm text-gray-500">
                      <div className="flex items-center gap-3 sm:gap-4">
                        <span className="flex items-center gap-1">
                          <BookCheck className="h-3 w-3 sm:h-4 sm:w-4 text-green-500" />
                          Estimated Read Time :{" "}
