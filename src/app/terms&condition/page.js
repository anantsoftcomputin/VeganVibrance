            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  By accessing and using technostalgia.com (hereinafter referred to
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      All content on technostalgia.com, including but not limited
                      to text, images, graphics, logos, and software, is the
                      property of technostalgia.com or its licensors and is
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      The content on technostalgia.com is provided for
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      To the fullest extent permitted by law, technostalgia.com and
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      You agree to indemnify and hold technostalgia.com harmless
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="mt-2 text-purple-600">
                  Email: support@technostalgia.com
                  <br />
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  ...
                  between you and technostalgia.com regarding your use of our Site,
